...
struct InnerBoundaryWeyl {
  ...
  using argument_tags = tmpl::list<
      Tags::Psi0Match, Tags::Dy<Tags::Psi0Match>, Tags::OneMinusY,
      Tags::BoundaryValue<Tags::BondiR>, Tags::BoundaryValue<Tags::BondiBeta>,
      Tags::BoundaryValue<Tags::SpECNormalization>, Tags::TetradCoeffTheta,
      Tags::TetradCoeffPhi, InitializationTags::ExtractionRadius, Tags::LMax>;
  static void apply(
      gsl::not_null<Scalar<SpinWeighted<ComplexDataVector, 2>>*> psi_0_boundary,
      gsl::not_null<Scalar<SpinWeighted<ComplexDataVector, 2>>*>
          dlambda_psi_0_boundary,
      gsl::not_null<Scalar<SpinWeighted<ComplexDataVector, 0>>*>
          tetrad_coeff_theta_boundary,
      gsl::not_null<Scalar<SpinWeighted<ComplexDataVector, 2>>*>
          tetrad_coeff_phi_boundary,
